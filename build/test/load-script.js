...
exports.default = (function () { return describe('vamtiger-person-abraham-mamela-json-ld', function () {
    before(function () {
    ...
    it('load script', function () {
        return __awaiter(this, void 0, void 0, function () {
            var script;
            return __generator(this, function (_a) {
                script = document.head.querySelector('[src="vamtiger-person-abraham-mamela-json-ld.js"]');
